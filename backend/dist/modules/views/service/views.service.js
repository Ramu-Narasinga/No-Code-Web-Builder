...
const views_dao_1 = __importDefault(require("../daos/views.dao"));
class ViewsService {
    updateSvgWithCount(count) {
  ...
  <text x="65" y="12" font-family="Arial" font-size="10" fill="white" text-anchor="middle">${count}</text>
        ...
        const $ = cheerio_1.default.load(svgContent, { xmlMode: true });
    ...
    incrViewsCount(url) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return (_a = yield views_dao_1.default.incrViewsCount(url)) !== null && _a !== void 0 ? _a : 0;
        });
    }
}
exports.default = new ViewsService();
//# sourceMappingURL=data:application/json;base64,